...
-- ================================================================
--   PRESET — fill this in your own script
-- ================================================================
--[[

local ZiaaUI = loadstring(game:HttpGet("YOUR_RAW_GITHUB_LINK_HERE"))()

-- Appearance
ZiaaUI.Appearance.Title = ""           -- hub name shown in header
ZiaaUI.Appearance.Icon  = ""           -- rbxassetid://...

-- Links
ZiaaUI.Links.Discord = ""              -- https://discord.gg/...
ZiaaUI.Links.GetKey  = ""              -- your get-key page URL

-- Storage
ZiaaUI.Storage.FileName = ""           -- filename for saved key (no extension)

-- Theme
ZiaaUI.Theme.Accent      = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.AccentHover = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.Background  = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.Header      = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.Input       = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.Text        = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.TextDim     = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.Success     = Color3.fromRGB( ,  ,  )
ZiaaUI.Theme.Error       = Color3.fromRGB( ,  ,  )

-- Shop bar
ZiaaUI.Shop = {
    Enabled    = true,
    Title      = "",                   -- e.g. "Get Premium"
    Subtitle   = "",                   -- e.g. "Instant delivery • 24/7 support"
    ButtonText = "",                   -- e.g. "Buy"
    Link       = "",                   -- your shop URL
}

-- Changelog (add one block per version, newest first)
ZiaaUI:AddChangelog("", "", {          -- version, date, { items }
    "",
})
